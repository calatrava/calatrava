...
//@interface HelloAllObject : NSObject
//@end

@interface HelloAllObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[HelloAllObject class]])
		{
			for (NSString *key in [[(HelloAllObject*)o modules] allKeys])
			{
