...
// in simulator we redefine to format for HelloAll Developer console
...
{\
	NSString * exceptionName = [@"org.helloall." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.helloall";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIHelloAllNativeItemNone = -1, 
	UIHelloAllNativeItemSpinner = -2,
	UIHelloAllNativeItemProgressBar = -3,
	
	UIHelloAllNativeItemSlider = -4,
	UIHelloAllNativeItemSwitch = -5,
	UIHelloAllNativeItemMultiButton = -6,
	UIHelloAllNativeItemSegmented = -7,
	
	UIHelloAllNativeItemTextView = -8,
	UIHelloAllNativeItemTextField = -9,
	UIHelloAllNativeItemSearchBar = -10,
	
	UIHelloAllNativeItemPicker = -11,
	UIHelloAllNativeItemDatePicker = -12,
	
	UIHelloAllNativeItemInfoLight = -13,
	UIHelloAllNativeItemInfoDark = -14,
	
	UIHelloAllNativeItemDisclosure = -15,
	
	UIHelloAllNativeItemContactAdd = -16
};
